...
const Phone = () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.32 1.77.59 2.61a2 2 0 0 1-.45 2.11L8 9.69a16 16 0 0 0 6.31 6.31l1.25-1.25a2 2 0 0 1 2.11-.45c.84.27 1.71.47 2.61.59A2 2 0 0 1 22 16.92z"/></svg>;
...
export function Contact() {
  ...
  const contactItems = [
    ...
    { icon: null, label: lang === 'en' ? 'Phone' : 'Telefon', value: profile.phone, href: `tel:${profile.phone}`, iconComp: <Phone /> },
        ...
        <div className="relative overflow-hidden rounded-[1.6rem] border border-border bg-page/90 shadow-card-lg">
          <div className="grid gap-0 lg:grid-cols-[1fr_430px]">
            <div className="p-6 md:p-10">
              <p className="section-eyebrow">{lang === 'en' ? 'Contact' : 'Iletisim'}</p>
